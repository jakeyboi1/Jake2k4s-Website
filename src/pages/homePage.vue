...
<template>
    <div class="w-screen text-center">
        ...
        <div class="w-96 h-34 ml-auto sm:pr-8 sm:pl-2"> <!--ml-auto puts it all the way to the left and helps mobile resolution using pr instead of px as its not in the center of page-->
